...
This will create a json file of the metadata for all the objects in the Brooklyn Museum collection. 
First, apply for an API key here: https://www.brooklynmuseum.org/opencollection/api/register
Then input your key into the config.template file, and save as config.py.
...
Download images from URLs generated by bkmus_image.py using img_from_url.py
Convert image to cross stitch using https://github.com/mbakija/Python_Cross_Stitch
Convert cross stitch pattern and key from SVG to PNG using svg_png.py
